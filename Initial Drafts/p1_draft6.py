...
liquidity_threshold = 1.0   # Current ratio below 1 can indicate possible liquidity failure
profitability_threshold = 0.05  # Minimum acceptable profit margin, below 5% is danger
